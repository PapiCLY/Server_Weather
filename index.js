...
app.get('/', (req,res)=>{
  ...
  res.render('index.ejs', {
    ...
    //tomorrow
        ...
        temp_2: `${Math.floor(lat_long_result.data.list[6].main.temp)}`,
    ...
    //3rd day
        ...
        temp_3: Math.floor(lat_long_result.data.list[14].main.temp),
    ...
    //4th day day
        ...
        temp_4: Math.floor(lat_long_result.data.list[22].main.temp),
    ...
    temp_5: Math.floor(lat_long_result.data.list[30].main.temp),
